...
//// gorouter
//
//func loadGoRoutes(e *Router, routes []*Route) {
...
//}
//
//func goHandler(method, path string) Handle {
//	return func(w http.ResponseWriter, req *http.Request, p *Param) {
//		w.WriteHeader(http.StatusOK)
//		w.Write([]byte("OK"))
//	}
//}
//
//func BenchmarkGoStatic(b *testing.B) {
//	e := New()
//	loadGoRoutes(e, static)
//	benchmarkRoutes(b, e, static)
//}
//
//func BenchmarkGoGitHubAPI(b *testing.B) {
//	e := New()
//	loadGoRoutes(e, githubAPI)
//	benchmarkRoutes(b, e, githubAPI)
//}
//
//func BenchmarkGoGplusAPI(b *testing.B) {
//	e := New()
//	loadGoRoutes(e, gplusAPI)
//	benchmarkRoutes(b, e, gplusAPI)
//}
//
//func BenchmarkGoParseAPI(b *testing.B) {
//	e := New()
//	loadGoRoutes(e, parseAPI)
...
func TestRouter(t *testing.T) {
	...
	router := New()
	router.GET("/test/:id/name", func(resp http.ResponseWriter, req *http.Request, params *Param) {
		ret := fmt.Sprintf("key = %s : value = %s", "id", params.GetValue("id"))
		resp.Write([]byte(ret))
	})

	router.GET("/test/hai/name", func(resp http.ResponseWriter, req *http.Request, params *Param) {
		resp.Write([]byte("success"))
	})

	router.GET("/test/aa/name/:testa/aa/:t/x", func(resp http.ResponseWriter, req *http.Request, params *Param) {
		ret, _ := json.Marshal(params)
		resp.Write(ret)
	})

	router.GET("/test/:id/name/:test/aa/:f/y", func(resp http.ResponseWriter, req *http.Request, params *Param) {
		ret, _ := json.Marshal(params)
		resp.Write(ret)
	})
